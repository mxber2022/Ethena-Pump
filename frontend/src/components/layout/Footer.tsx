        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              The next generation platform for creating and trading meme tokens on the blockchain.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#tokens" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Browse Tokens
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#guide" className="text-gray-400 hover:text-white transition-colors text-sm">
                  User Guide
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-1 text-sm text-gray-400 mt-4 sm:mt-0">
              ...
              <span>by MemeToken Factory Team</span>
            </div>
          </div>
        </div>
      </div>
